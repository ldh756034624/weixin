...
router.beforeEach((to, from, next) => {
  ...
  if (sessionStorage.isInResult === 'true') {
    ...
    sessionStorage.paySuccess = 'false'
    next('/index')
  } else if(from.path === '/hotel/fail' && sessionStorage.payCheckOrder == 'true' ){  //从酒店支付失败页来到首页
...
} else if (url.indexOf('weixin-dev-h9.thy360.com') != -1 || url.indexOf('localhost') != -1 || url.indexOf('172.16') != -1) {
