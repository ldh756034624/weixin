  ...
  <div class="page">
    <group class="purseBox">
      ...
      <div class="purseCont flexBox">
        ...
        <x-button mini
                  class='purseFundBtn'
                  @click.native="handleRecharge">充值</x-button>
      </div>
      <cell title="酒元明细"
            link='/account/purseParticulars'
            is-link>
        <img slot="icon"
             class="jyimg"
    ...
    <flexbox :gutter="0"
      ...
      <flexbox-item class='ItemBorder'
                    v-show="purseData.canTransConfig">
    ...
    <!-- <flexbox :gutter="0"
      ...
      <flexbox-item v-show="!purseData.canWithdeawal"
                    class='ItemBorder'>
      </flexbox-item>
      <flexbox-item class='ItemBorder'>
      </flexbox-item>
